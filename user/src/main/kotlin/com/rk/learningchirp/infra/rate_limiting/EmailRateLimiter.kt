package com.rk.learningchirp.infra.rate_limiting

import com.rk.learningchirp.domain.exception.RateLimitException
...
class EmailRateLimiter(
    ...
    companion object {
        ...
        private const val PASSWORD_ATTEMPT_COUNT_PREFIX = "email_attempt_count"
    }
    ...
    fun withRateLimit(
        ...
        val attemptCountKey = "$PASSWORD_ATTEMPT_COUNT_PREFIX:$normalizedEmail"
